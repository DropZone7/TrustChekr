...
const ARTICLES: Article[] = [
  {
    ...
    body: [
      ...
      "Arkansas filed the first state lawsuit against Temu in June 2023, alleging the app operates as spyware. A report from Grizzly Research flagged 18 specific device permissions the app requests, including clipboard access and location tracking. The CAFC has warned Canadians about suspiciously cheap online shopping platforms that harvest personal data at scale. Temu denied the allegations, but the lawsuit is ongoing.",
      "Product quality is the other gamble. Items ship directly from Chinese manufacturers at prices that seem impossible — $3 headphones, $7 jackets — because they often are. Temu operates at a significant loss per order, spending an estimated $30 in customer acquisition costs for every new buyer according to analysts at Bernstein. The deep discounts are subsidized, not fraudulent, but you get what you pay for. Reviews on BBB and Trustpilot consistently describe items that look nothing like their listing photos.",
  ...
  },
  {
    ...
    body: [
      "CBC Marketplace tested Shein children's clothing in 2023 and found lead levels up to 20 times higher than Health Canada's safety limit. Shein is not a scam — it is a $60 billion fast-fashion empire that ships real products — but \"real\" does not mean \"safe.\"",
      ...
      "Intellectual property theft is a pattern, not an accident. Shein has faced dozens of lawsuits from independent designers and major brands — including a $100 million suit from Levi Strauss in 2023. Several cases have been settled. For shoppers, this does not affect order safety, but it reveals how the company operates.",
  ...
  },
  {
    ...
    body: [
      ...
      "The BBB identified online purchase scams — many originating on social media marketplaces — as the riskiest scam type in North America in 2024. The CAFC has documented a surge in Marketplace-related fraud across Canada, with rental scams, non-delivery schemes, and counterfeit goods topping the list. The FTC reported that social media was the #1 channel for reported fraud in 2023, with $1.4 billion in losses.",
      "Rental scams are the most financially devastating pattern. Scammers copy real listings from Realtor.ca or Kijiji, repost them on Marketplace at $200 to $400 below market rate, then collect deposits from multiple victims before vanishing. The RCMP and police services across Ontario and British Columbia have issued repeated warnings. Victims typically lose $1,000 to $3,000 each.",
  ...
  },
  {
    ...
    body: [
      "Block, Inc. settled a $175 million class action lawsuit in 2023 over allegations that Cash App made it too easy for scammers to steal money — and too hard for victims to get it back. The app is not a scam. But its design makes it one of the most exploited payment tools in North America.",
      ...
      "The most common scams: fake giveaways promising to double your money (the FTC says these pulled in over $80 million across platforms in 2023), impersonation of Cash App support on Twitter and Instagram, romance scams requesting Cash App payments, and \"money flipping\" schemes. All rely on the same vulnerability — once you hit send, the money is gone.",
  ...
  },
  {
    ...
    body: [
      "PayPal processes over $1.5 trillion in payments annually and is the most impersonated financial brand in phishing emails worldwide. It is emphatically not a scam — but scammers impersonate it so aggressively that the FTC and the CAFC both issue warnings about fake PayPal emails every year.",
  ...
  },
  {
    ...
    body: [
      ...
      "Zelle is operated by Early Warning Services, LLC — owned by Bank of America, Capital One, JPMorgan Chase, PNC, Truist, U.S. Bank, and Wells Fargo. It is embedded in over 1,700 banking apps and moved $806 billion in 2023. This is not a startup or a fintech experiment. It is the banking industry's answer to Venmo.",
      ...
      "Zelle is not widely available in Canada — Interac e-Transfer fills the same role here. But Canadians with U.S. bank accounts or cross-border transactions may encounter it. The CAFC's advice applies equally: never send instant, irreversible payments to anyone you have not verified in person.",
  ...
  },
  {
    ...
    body: [
      ...
      "Coinbase (NASDAQ: COIN) went public in April 2021 and is registered as a Money Services Business with FinCEN, holds licenses in most U.S. states, and is registered with FINTRAC in Canada. It is the largest regulated crypto exchange in the United States, holding over $130 billion in customer assets as of late 2025. This is a real, audited financial institution.",
      "The biggest risk to Coinbase users is not Coinbase itself — it is scammers impersonating Coinbase. The FBI's IC3 reported over $5.6 billion in crypto fraud losses in 2023, and impersonation of exchanges is one of the top vectors. The script is predictable: a call or text warns of unauthorized account activity, directs you to a fake website, and captures your credentials or convinces you to install remote access software.",
  ...
  },
  {
    ...
    body: [
      ...
      "Interac Corp. has run Canada's interbank network since 1984. Every major bank supports e-Transfer. The system itself is not a scam — it is regulated, encrypted, and genuinely secure. The CAFC reported $638 million in total fraud losses across Canada in 2024, and e-Transfer was the most common payment method in reported scams, according to CAFC data. The problem is not the technology. The problem is that scammers have a favorite tool, and this is it.",
      ...
      "Once an e-Transfer is deposited, your bank can only claw it back if the recipient's bank cooperates — which rarely happens. TD, RBC, and Scotiabank have added fraud warning prompts that flag unusual transfers, but these vary by institution and are not foolproof. Speed is everything: if you realize you sent money to a scammer, call your bank within minutes.",
