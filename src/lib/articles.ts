...
const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    verdict: "Educational",
    summary:
      "The FBI's IC3 reported $9.3 billion in cryptocurrency fraud losses in 2024 — up 66% from $5.6 billion the year before. Pig butchering alone accounted for $5.8 billion. Most scams follow a small number of patterns that are easy to recognize once you know what to look for.",
    body: [
      "The FBI's IC3 reported $9.3 billion in crypto fraud losses in 2024 — a 66% jump from $5.6 billion in 2023. In Canada, the CAFC flagged crypto as the top payment method in investment fraud. You do not need to understand blockchain to protect yourself. You just need to spot five patterns.",
