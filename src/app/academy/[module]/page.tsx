...
const modules: Record<string, ModuleData> = {
  ...
  "tech-support-scams": {
    ...
    keyPoints: [
      ...
      "Tech support scams cost Canadians over $20 million in 2023 according to the CAFC — the average victim lost thousands of dollars",
  ...
  "social-media": {
    ...
    keyPoints: [
      ...
      "Social media fraud reports to the CAFC topped 20,000 in 2023 — with losses exceeding $120 million across all platform-related scams",
  ...
  "what-to-do": {
    ...
    keyPoints: [
      ...
      "Only 5 to 10 percent of fraud victims in Canada report to the CAFC — every unreported scam lets criminals keep operating",
